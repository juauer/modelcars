...
class trajectory_movement {
 public:
  trajectory_movement(ros::NodeHandle nh) {
    ...
    subScan_ = n_.subscribe("scan", 1, &trajectory_movement::scanCallback,this);
    subTwist_ = n_.subscribe("motor_control/twist",1,&trajectory_movement::speedCallback,this); 
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "trajectory_movement_node");
  ros::NodeHandle nh; 
  trajectory_movement trajectoryMovementObject(nh);
